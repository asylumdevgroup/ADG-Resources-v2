package com.endangerednayla.asylumresources.util;
...
public class ModTags {
    public static class Blocks {
        ...
        private static TagKey<Block> tag(String name) {
            return BlockTags.create(new ResourceLocation(com.endangerednayla.asylumresources.AsylumRes.MOD_ID, name));
        }
    ...
    public static class Items {
        ...
        private static TagKey<Item> tag(String name) {
            return ItemTags.create(new ResourceLocation(com.endangerednayla.asylumresources.AsylumRes.MOD_ID, name));
        }
